...
<?php include 'navbar.php' ?>
				...
				<center>
					...
					<h5 class="white-txt">Vote for the server and recieve epic rewards AND help the server grow!</h5>
				</center><br><br><br><br>
</div><br>
...
<div class="col-md-3">
  ...
  <div class="panel-body">
    Voting for Minecraft Server helps us grow, and rewards you with awesome in-game stuff (see below)!
  </div>
</div>
	<div class="panel panel-default">
  <div class="panel-heading">
